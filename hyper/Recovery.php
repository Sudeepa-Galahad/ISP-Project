                  ...
                  <div class="full">
                     <div class="page_title">
                        <div class="full heading_s1">
                           <h2><span>Account Recovery</span></h2>
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-md-12">
                  <div class="contact_section margin_top_30">
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form_cont">
                               <form name="recover" method="post" action="recov.php" >
                                  <fieldset>
                                     <div class="field">
                                      ...
                                      <br>
                                       <div class="field">
                                           <b>In what city were you born ?</b>
                                        <input id="ans" type="text" name="ans" placeholder="Answer" required/>
                                     </div>
                                     <div class="field center">
                                       <button name="sigsb" type="submit" name="sigsb">Submit</button>
                                  </fieldset>
                                      <br>
                                      <center>
                                      <p style="color:yellow" > Already a member ? <a href="#">Login</a></p>
                                    </center>
                               </form>
