              ...
              <div class="col-md-12">
                <div class="contact_section margin_top_30">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="gold_con">
                        <img src="images/Preview%20Image.jpg" alt="#" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form_cont">
                        <form id="login" action="log.php" method="post">
                          <fieldset>
                            ...
                            <div class="field center">
                              <button name="Lg_sub" id="log_sub" type="submit" onclick="myFunction()">Login</button>
                            </fieldset>
                          </form>
                        </div>
                        <center><p style="color:aliceblue" >New Member ? <a href="signup.php">Signup</a></p></center>
                        <center><p style="color:aliceblue" ><a href="Recovery.php">Forgot Password ?</a></center>
